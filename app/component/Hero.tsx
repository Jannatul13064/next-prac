      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 flex flex-col-reverse lg:flex-row items-center">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6">
          ...
          <p className="text-lg sm:text-xl text-black animate-fadeIn delay-200">
            Discover the power of precision with <span className="font-semibold">Ultrasound Edan LX3</span> and 
            <span className="font-semibold"> Rayence FPD</span>. Cutting-edge technology designed for professionals.
          </p>
